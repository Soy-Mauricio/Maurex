    ...
    return (
        ...
        <div className="flex justify-center items-center mt-10">
            <div className="flex flex-col w-[50%]">
                <div className="flex">
                    <h3 className="text-3xl font-medium text-colorAction-TITTLE">{title}</h3>
                </div>
                ...
                <button className="mt-10 bg-colorAction-TITTLE text-white w-[160px] transform transition-transform duration-700 hover:scale-105 will-change-transform backface-visibility-hidden">
                    <Link to='/view-more'
