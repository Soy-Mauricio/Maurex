      ...
      <section className='h-[auto] mt-10'>
        ...
        <div className='h-[auto] p-4 max-w-[1200px] w-full mx-auto'>
          <div className='sm:mx-8'>
            <div className='flex justify-center sm:w-[90%]'>
              <div className=''>
                <div className='flex mb-8'>
                  <hr className="border-t-4 sm:w-[5%] w-[15%] border-black opacity-80 my-4" />
                </div>
                <h2 className='text-3xl opacity-80 font-bold'>Tecnologías</h2>
                <p className='mt-4 text-2xl opacity-80 sm:w-[70%]'>El equipo de desarrollo que trabaja en un proyecto utiliza únicamente tecnologías modernas y escalables para implementar aplicaciones móviles y web tal como usted lo desea.</p>
              </div>
            </div>
